...
def predict():
    ...
    if result:
        return render_template("chance.html", predict=pred['predictions'][0]['values'][0][1][1]*100)
    else:
        return render_template("nochance.html", predict=pred['predictions'][0]['values'][0][1][1]*100)
